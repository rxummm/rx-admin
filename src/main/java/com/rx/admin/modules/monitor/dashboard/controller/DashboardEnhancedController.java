...
public class DashboardEnhancedController {
    ...
    public Result<?> loginStats() {
        ...
        data.put("todayLogins", loginLogMapper.selectCount(
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog>()
                .ge(com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog::getLoginTime, todayStart)
                .eq(com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog::getStatus, 1)));
        // 今日失败登录数
        data.put("todayFailLogins", loginLogMapper.selectCount(
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog>()
                .ge(com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog::getLoginTime, todayStart)
                .eq(com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog::getStatus, 0)));
        // 最近7天每日登录趋势
        LocalDateTime sevenDaysAgo = LocalDate.now().minusDays(6).atStartOfDay();
        var trendQuery = new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<com.rx.admin.modules.monitor.loginlog.entity.SysLoginLog>()
    ...
    public Result<?> exportStats() {
        ...
        data.put("todayExcelExports", exportLogMapper.selectCount(
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.rx.admin.modules.monitor.exportlog.entity.SysExportLog>()
                .ge(com.rx.admin.modules.monitor.exportlog.entity.SysExportLog::getCreateTime, todayStart)
                .eq(com.rx.admin.modules.monitor.exportlog.entity.SysExportLog::getExportType, "excel")));
        data.put("todayPdfExports", exportLogMapper.selectCount(
            new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.rx.admin.modules.monitor.exportlog.entity.SysExportLog>()
                .ge(com.rx.admin.modules.monitor.exportlog.entity.SysExportLog::getCreateTime, todayStart)
                .eq(com.rx.admin.modules.monitor.exportlog.entity.SysExportLog::getExportType, "pdf")));
        return Result.ok(data);
    }
    ...
    public Result<?> operationTop10() {
        ...
        LocalDateTime todayStart = LocalDate.now().atStartOfDay();
        var topQuery = new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<com.rx.admin.modules.monitor.log.entity.SysLog>()
