...
public class MusicController {
    ...
    public MusicController(MusicService musicService, SongConvert songConvert, PlayRecordConvert playRecordConvert) {
        this.musicService = musicService;
        this.songConvert = songConvert;
        this.playRecordConvert = playRecordConvert;
    }
