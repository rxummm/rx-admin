...
import com.rx.admin.modules.system.file.service.SysFileService;
import com.rx.admin.modules.system.file.convert.FileConvert;
...
public class SysFileController {
    ...
    public Result<FileVO> upload(@RequestParam("file") MultipartFile file,
        ...
        return Result.ok(fileConvert.toVO(sysFile));
    }
