...
public class SysPermissionRequestController {
    ...
    public SysPermissionRequestController(SysPermissionRequestService requestService, PermissionRequestConvert requestConvert) {
    ...
    @PostMapping
    @SaCheckLogin
    public Result<?> submit(@RequestBody PermissionSubmitDTO dto) {
    ...
    @SaCheckLogin
    public Result<?> emailRequest(@RequestBody EmailPermissionRequestDTO dto) {
        long userId = StpUtil.getLoginIdAsLong();
