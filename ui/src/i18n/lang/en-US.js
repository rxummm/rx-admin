export default {
  ...
  as400: {
    ...
    analysis: {
      title: 'Code Analysis',
      subtitle: 'RPGLE / RPG III / CL / DDS Source Parser',
      sourceType: 'Source Type',
      analyze: 'Analyze',
      sample: 'Sample',
      clear: 'Clear',
      editorPlaceholder: 'Paste AS400 source code here...\nSupports RPGLE, RPG III, CL, DDS (PF/LF/DSPF/PRTF)',
      ...
      flowchart: 'Flowchart',
      details: 'Details',
      empty: 'Paste source code and click "Analyze" to see results',
      exportFlowchart: 'Export Image',
      legProcedure: 'Procedure',
      legControl: 'Control',
      legIO: 'I/O',
  ...
  tool: {
    ...
    videoPlayer: {
      title: 'Video Player',
      scanFolder: 'Scan Video Folder',
      scanning: 'Scanning...',
      scanComplete: 'Scan complete',
      scanFailed: 'Scan failed',
      playFailed: 'Playback failed',
      noVideos: 'No videos',
      noVideosPrompt: 'No videos, please click scan to load',
      loadingText: 'Loading...',
      ...
      videoCount: 'videos',
      urlPlay: 'URL Play',
      urlPlaceholder: 'Paste video URL (mp4/m3u8/Bilibili/YouTube)',
      playUrl: 'Play',
      fileName: 'File Name',
      fileSize: 'File Size',
  ...
  profile: {
    ...
    oldPasswordChangePlaceholder: 'Required when changing password',
  ...
  permission: {
    ...
    request: {
      ...
      reloginHint: 'Approved permissions take effect after re-login',
  ...
  audio: {
    transcription: {
      keyword: 'Enter file name keyword',
      language: 'Language',
  ...
  ocr: {
    ...
    description: 'Supports text recognition for PDF, Word, and images',
    upload: {
      title: 'File Upload',
    ...
    action: {
      ...
      cancel: 'Cancel',
      cancelRecognition: 'Cancel Recognition',
      copy: 'Copy Text',
