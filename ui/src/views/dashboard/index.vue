  ...
  try {
    ...
    sseEventSource.addEventListener("enhanced", (event) => {
      try {
        ...
        if (parsed.code === 200 && parsed.data) {
          const d = parsed.data
          loginStats.value = { todayLogins: d.todayLogins, todayFailLogins: d.todayFailLogins, trend: d.trend }
          exportStats.value = d.exportStats
          operationTop10.value = d.operationTop10
          renderLoginTrendChart()
          renderOperationTopChart()
        }
