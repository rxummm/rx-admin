    ...
    <el-dialog v-model="dialogVisible" :title="dialogTitle" width="700px" :close-on-click-modal="false">
      <el-form ref="formRef" :model="form" :rules="formRules" label-width="90px">
        ...
        <el-form-item label="诗词类型" prop="poemType">
          <el-input v-model="form.poemType" placeholder="如：诗、词、偈语等" />
        </el-form-item>
        <el-form-item label="场景/回目">
          <el-input v-model="form.relatedScene" placeholder="如：第七回 八卦炉中逃大圣" />
        </el-form-item>
        <el-form-item label="相关人物">
          <el-input v-model="form.relatedCharacter" placeholder="如：孙悟空、如来佛祖" />
        </el-form-item>
...
const formRules = {
  ...
  poemType: [{ required: true, message: '请输入诗词类型', trigger: 'blur' }],
