...
export function getTodoCountApi() {
  return request({ url: '/content/notice/todo-count', method: 'get' })
}

export function addNoticeApi(data) {
  return request({ url: '/content/notice', method: 'post', data })
}

export function updateNoticeApi(data) {
  return request({ url: '/content/notice', method: 'put', data })
}

export function deleteNoticeApi(id) {
  return request({ url: `/content/notice/${id}`, method: 'delete' })
}
...
export function getNoticeByIdApi(id) {
  return request({ url: `/content/notice/${id}`, method: 'get' })
}
...
export function getReadNoticeIdsApi() {
  return request({ url: '/content/notice/read-ids', method: 'get' })
}
...
export function markNoticeReadApi(id) {
  return request({ url: `/content/notice/read/${id}`, method: 'post' })
}
...
export function markAllNoticeReadApi() {
  return request({ url: '/content/notice/read-all', method: 'post' })
}
